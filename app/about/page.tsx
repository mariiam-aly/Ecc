...
<p  className="title-sm">  المركز الإستشاري المصري</p>
<p className="title-lg" >   عملائنا</p>
<p className="div1Det">تأسست المركز الاستشاري المصري في ١٩٩٨, وقد اكتسب سمعة ممتازة في تقديم خدمات الاستشارات المالية ذات الجودة العالية. هدفنا هو تقديم حلول مبتكرة وشخصية لتحديات عملائنا المالية.</p>
...
<p  className="title-sm">  المركز الإستشاري المصري</p>
<p className="title-lg" >   الأهداف ، الرؤية والرسالة</p>
<p className="div1Det">تأسست المركز الاستشاري المصري في ١٩٩٨, وقد اكتسب سمعة ممتازة في تقديم خدمات الاستشارات المالية ذات الجودة العالية. هدفنا هو تقديم حلول مبتكرة</p>
...
<p className="goal-title">الأهداف</p></div>
...
<p className="goal-title">الرؤية</p></div>
<p className="goal-det">نسعى لأن نكون من افضل المكاتب فى تقديم الخدمات المالية والادارية لعملائنا على مستوى مصر و المنافسة القوية على مستوى الوطن العربى</p>
</div>
	</div>
</div>
...
<p className="goal-title">الرسالة</p></div>
<p className="goal-det">نسعى لأن نكون من افضل المكاتب فى تقديم الخدمات المالية والادارية لعملائنا على مستوى مصر و المنافسة القوية على مستوى الوطن العربى</p>
</div>
	</div>
</div></div></div>
