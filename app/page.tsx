...
<div className="alignVertical div1-padding container-ecc">
			...
			<h2>في المركز الاستشاري المصري، نقدم مجموعة شاملة من الخدمات المالية المصممة لدعم نمو أعمالك. بفريقنا الخبير بجانبك، ستتمكن من فهم القضايا المحاسبية والضريبية المعقدة، وستتمكن من اتخاذ قرارات مستنيرة لقيادة أعمالك إلى الأمام. نحن نؤمن بتقديم التميز في كل جانب من جوانب خدماتنا، وتقديم الرؤى لتعزيز الصحة المالية لأعمالك.</h2>
...
<h3>  خدماتنا</h3>
<h1 >المركز الإستشاري المصري</h1>
<h2>في المركز الاستشاري المصري، نقدم مجموعة شاملة من الخدمات المالية المصممة لدعم نمو أعمالك. بفريقنا الخبير بجانبك</h2>
<div className="container-fluid">
...
<h3>  خدماتنا</h3>
<h1 >  من نحن</h1>
<h2>تأسست المركز الاستشاري المصري في ١٩٩٨, وقد اكتسب سمعة ممتازة في تقديم خدمات الاستشارات المالية ذات الجودة العالية. هدفنا هو تقديم حلول مبتكرة وشخصية لتحديات عملائنا المالية. يتألف فريقنا من محترفين متفانين لديهم خبرة واسعة وقادرون على تقديم حلول شاملة. نحن متخصصون في الخدمات مثل التدقيق المالي، الخدمات المحاسبية، تأسيس الشركات، الدراسات الجدوى، تمويل المشروعات، والاستشارات الضريبية. نحن ندرك أن كل عمل تجاري فريد من نوعه، ولذلك نقدم خدماتنا وفقًا لاحتياجات كل عميل، مع تقديم استراتيجيات عملية تؤدي إلى نتائج ملموسة. في المركز الاستشاري المصري، نعتبر عملائنا شركاء لنا، حيث نعمل معاً نحو هدف مشترك - نجاحك. كشركائك، نعد بتوجيهك من خلال التعقيدات المالية، وتوفير الوضوح ومساعدتك في اتخاذ القرارات المستنيرة. نتطلع إلى أن نكون شريكك الموثوق في تحقيق أهدافك المالية.</h2>
